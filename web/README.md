...
- Portable JSON save export/import bridge for moving browser state between sessions or future backend tools.
...
- richer backend sync on top of the current JSON export/import bridge
